...
namespace OctoPlusCore.Configuration
{
    ...
    public class OctoPlusDeployLatestOptions
    {
        ...
        [Option('s', "forcedeployifsamepackage", Required = false, HelpText = "Force the project deployment if its the same package")]
        public bool ForceDeploymentIfSamePackage { get; set; }

        [Option('e', "environmentname", Required = false, HelpText = "Environment to deploy to")]
